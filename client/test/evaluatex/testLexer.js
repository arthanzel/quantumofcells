...
describe("Evaluatex Lexer", function() {
    it("should lex equations", function() {
        ...
        assert.equal(str, "TLPAREN[(] TMINUS TSYMBOL[b] TPLUS TFUNCTION[sqrt] TLPAREN[(] TSYMBOL[b] TPOWER TNUMBER[2] TMINUS TNUMBER[4] TTIMES TSYMBOL[a] TTIMES TSYMBOL[c] TRPAREN[)] TRPAREN[)] TDIVIDE TLPAREN[(] TNUMBER[2] TTIMES TSYMBOL[a] TRPAREN[)]", "quadratic not equal");
        ...
        assert.equal(str, "TFUNCTION[sin] TLPAREN[(] TNUMBER[0.5] TRPAREN[)] TPOWER TNUMBER[2] TPLUS TFUNCTION[cos] TLPAREN[(] TMINUS TNUMBER[0.5] TRPAREN[)] TPOWER TNUMBER[2]", "trig not equal");
